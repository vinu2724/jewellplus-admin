...
import { FooterFormData } from "../SalesComponents/Sales";

interface FooterProps {
  footerData: FooterFormData;
}

const SalesFooter: React.FC<FooterProps> = ({ footerData }) => {
  ...
  return (
    ...
    <div className="flex flex-wrap justify-between items-center gap-4 text-black text-sm font-[var(--font-inter)]">
        {[
          ...
          <div key={index} className="flex flex-col items-center justify-center flex-1 min-w-[150px] max-w-[220px] px-2 py-2 bg-blue-50 rounded-lg shadow-sm border border-blue-100"
>
