...
interface PrintableOrderNoteProps {
  main?: OrderMainType;
  detail?: OrderDetailType[];
}

const PrintableOrderNote = forwardRef<HTMLDivElement, PrintableOrderNoteProps>(
  ({ main, detail }, ref) => {
          ...
          return (
            ...
            >
              ...
              >
                ...
                >
                  <div>
                    Other Charges : {Number(item.Other_Charges).toFixed(2)}
                  </div>
                  <div>Making : {Number(item.Making).toFixed(2)}</div>

                  <div>GST : {(item.Sgst_Amt + item.Cgst_Amt).toFixed(2)}</div>
                </div>
              </div>
...
PrintableOrderNote.displayName = "PrintableOrderNote";
export default PrintableOrderNote;
